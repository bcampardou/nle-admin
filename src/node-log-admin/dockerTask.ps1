...
.PARAMETER Clean
Removes the image node-log-admin and kills all containers based on that image.
...
Build a Docker image named node-log-admin
#>
...
$imageName="node-log-admin"
$projectName="nodelogadmin"
$serviceName="node-log-admin"
